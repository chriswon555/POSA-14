...
public class DownloadIntentService extends IntentService {
	...
	protected void onHandleIntent (Intent intent) {
        ...
        String uri = DownloadUtils.downloadFile(getApplicationContext(), Uri.parse(intent.getDataString()));
        DownloadUtils.sendPath(uri, (Messenger)intent.getExtras().get(DownloadUtils.MESSENGER_KEY));
    }
}
