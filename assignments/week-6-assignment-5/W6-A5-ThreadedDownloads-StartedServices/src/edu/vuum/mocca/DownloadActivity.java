...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
            ...
            if (activity != null) {
                ...
                String uri = msg.getData().getString(DownloadUtils.PATHNAME_KEY);
                outerClass.get().displayBitmap(uri);
            }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
            ...
            Intent tIntent = DownloadIntentService.makeIntent(this, handler, getUrlString());
